...
![文本缩进继承](../images/InheritanceOfTextIndent.png)
...
![图像的基线对齐](../images/bottomAlignedWithFatherbaseline.png)
...
![上标和下标对齐](../images/subandsuper.png)
...
![居中对齐的详细说明](../images/vertical-align-middle.png)
...
![垂直对齐会使文本行变高](../images/vertical-align-effect.png)
...
![改变字间间隔](../images/word-spacing1.png)
...
![各种字母间隔](../images/letter-spacing1.png)
...
![white-space属性](../images/white-space-table.png) 
